...
<head>
    ...
    <style>
.navbar {
            background-image: url('https://cdn.latinus.us/wp-content/uploads/2020/04/16161619/concierto-1024x682.jpg');
...
.custom-toggler.navbar-toggler {
    border-color: #fff; /* Color del borde negro */
    background-color: #6962b9; /* Color de fondo blanco */
}
/* Configurar el trazo (stroke) a blanco usando valores rgb */
...
<body>
    <nav class="navbar bg-body-tertiary fixed-top">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand mx-auto navbar-brand-custom" href="#" style="color: #3B3486; font-size: 50px; font-weight: 700;">GigSpot</a>
        </div>
    ...
    <!-- Asegúrate de incluir Bootstrap JS y Popper.js (si es necesario) -->
