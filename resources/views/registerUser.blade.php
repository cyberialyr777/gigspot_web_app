  ...
  <div class="container">
    ...
    <div class="form-container">
      <div class="title">
        ...
        <br>
        <div class="text">
          <p>Fill the form below correctly for user register</p>
        </div>
      </div>
      ...
      <form action="" method="post">
        <label for="emailOrUsername">
          ...
          <input class="input" type="text" id="emailOrUsername" name="name" required>
          ...
          <input class="input" type="text" id="emailOrUsername" name="lastName" required>
          ...
          <input class="input" type="text" id="emailOrUsername" name="user" required>
